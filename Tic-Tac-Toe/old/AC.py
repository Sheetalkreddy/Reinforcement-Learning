...
class PGAgent():
    ...
    def __train_func(self):
        ...
        self.train_fn = K.function(inputs=[self.model.input,action_onehot_placeholder,discount_reward_placeholder],outputs=[loss,action_prob_placeholder,action_onehot_placeholder,discount_reward_placeholder,action_prob,log_action_prob,loss2],updates=updates)
